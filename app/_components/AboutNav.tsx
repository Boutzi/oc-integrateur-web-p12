          ...
          >
            {menuItems.map((link, index) => (
              <Link
                ...
                className={`${
                  pathname === link.href &&
                  "font-semibold text-primary max-xl:border max-xl:bg-primary max-xl:py-1 max-xl:px-3 max-xl:rounded-full max-xl:text-background"
                } hover:text-primary max-xl:border max-xl:border-accent max-xl:text-foreground max-xl:py-1 max-xl:px-3 max-xl:rounded-full max-xl:hover:bg-primary max-xl:hover:text-background max-xl:font-semibold`}
              >
                {link.label}
              </Link>
            ))}
